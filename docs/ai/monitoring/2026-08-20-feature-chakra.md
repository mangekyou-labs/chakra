...
> **Phase 1 status:** This file is a placeholder. Fill it during the monitoring lifecycle phase. v1 gates already named: `/health` vs `/ready`, quote p95 &lt; 500 ms, worker refresh of touched pools, aggregator pause as kill switch.
