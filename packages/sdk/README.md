...
TypeScript client for the [Chakra](https://Chakra.xyz) REST API — quote, build_tx, tokens, balances, health. No wallet secrets; all signing happens in the user's wallet.
...
`prefer_arc` or a percent `slippage`. Envelope failures throw
