...
describe('ChakraClient.quote', () => {
  it('encodes token_in/token_out/amount_in/slippage_bps and never sends prefer_soroban or percent slippage', async () => {
    stubFetch((url) => {
      ...
      expect(parsed.searchParams.has('prefer_soroban')).toBe(false);
