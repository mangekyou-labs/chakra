...
impl TokenMetadataStore {
    pub fn new(_rpc: Arc<ArcRpc>) -> Self {
    ...
    async fn prefers_sep42_list_icon_over_stale_metadata_url() {
        ...
        initial.insert(
            ...
            TokenMetadata {
                ...
                name: "Sep".to_string(),
                logo: Some("https://Arc.expert/explorer/public/asset/native/icon".into()),
                logo_kind: None,
            },
        );
